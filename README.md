...
```sh
  git clone https://github.com/kamranahmad123/test-Project
```
...
> [github html preview](https://github.com/kamranahmad123/test-Project) and paste index adress into it to view.
